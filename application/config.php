...
return [
    ...
    'wx_config' => [
        ...
        'md5_key'           => '885bbe7b923f7799e49e4e6f0de3c385',// md5 秘钥//'885bbe7b923f7799e49e4e6f0de3c385',
        'app_cert_pem'      => '/www/wwwroot/new_retail_api.zhifengwangluo.com/data/cert/apiclient_cert.pem',
        'app_key_pem'       => '/www/wwwroot/new_retail_api.zhifengwangluo.com/data/cert/apiclient_key.pem',
        // 'app_cert_pem'      =>'/www/wwwroot500g/New_retail/data/cert/apiclient_cert.pem',
        // 'app_key_pem'       =>'/www/wwwroot500g/New_retail/data/cert/apiclient_key.pem',
        ...
        'notify_url'        => 'http://api.puruitingxls.com/api/pay/weixin_notify/',

        'redirect_url'      => 'http://www.puruitingxls.com/',// 如果是h5支付，可以设置该值，返回到指定页面
        ...
        'pay_config' => [
            ...
            // 与业务相关参数
            'notify_url'                =>  SITE_URL.'/api/pay/alipay_notify/',
            'return_url'                => 'http://newretailwebtest.zhifengwangluo.com',
