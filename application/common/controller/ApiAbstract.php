...
class ApiAbstract extends Controller
{
    ...
    public function _initialize()
    {
        ...
        $this->rmb_toaus=Db::name('exchange_rate')->where(['id'=>1])->value('rmb_toaus');
        $this->aus_tormb=Db::name('exchange_rate')->where(['id'=>1])->value('aus_tormb');
...
//        }
    ...
    public function failResult($message, $status = 200)
    {
