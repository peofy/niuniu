...
{   
    ...
    public function index()
    {
        ...
        if( request()->isPost() ){
            ...
            if( isset($data['alipay_qr_code']) ) $data['alipay_qr_code'] = $this->base_img($data['alipay_qr_code'],'site','alipay_qr_code',$this->info['alipay_qr_code']);

            if( isset($data['wechat_qr_code']) ) $data['wechat_qr_code'] = $this->base_img($data['wechat_qr_code'],'site','wechat_qr_code',$this->info['wechat_qr_code']);
