...
class Goods extends Common
{
    ...
    {   
        ...
        if( Request::instance()->isPost() ){
            ...
            $data['stock'] = array_sum($data['goods_td']['num']);
...
//        }
    ...
    public function cat2(){
        ...
        //商品二级分类
        $cat2 = Db::table('category')->where('pid',$cat_id)->select();
        if ($cat2) {
            $res['code'] = 1;
            $res['data'] = $cat2;
            $res['msg'] = '成功';
...
//        dump($info);die;
        ...
        $cat_id1 = Db::table('category')->where('level',1)->select();
        //商品二级分类
        $cat_id2 = Db::table('category')->where(['level'=>2,'pid'=>$info['cat_id1']])->select();
        //商品组图
